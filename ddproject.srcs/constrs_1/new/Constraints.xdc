...
set_property PACKAGE_PIN N19 [get_ports {debug[6]}]
set_property PACKAGE_PIN M20 [get_ports {debug[5]}]
set_property PACKAGE_PIN K13 [get_ports {debug[4]}]
set_property PACKAGE_PIN K14 [get_ports {debug[3]}]
set_property PACKAGE_PIN M13 [get_ports {debug[2]}]
set_property PACKAGE_PIN L13 [get_ports {debug[1]}]
